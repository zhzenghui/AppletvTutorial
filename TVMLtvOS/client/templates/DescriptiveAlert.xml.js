...
Keep it short and avoid scrolling. Reading lots of text on a distant screen strains the eyes and isn’t much fun. Seriously consider how much text your app really needs to display.

Show, don’t tell. Whenever possible, try to avoid descriptive alert text. See if you can present the same information in a more digestible way, such as with images.

Place buttons carefully. Position buttons side by side when there’s scrollable text. This way, scrolling up and down scrolls the text, while scrolling left and right switches focus between buttons.
