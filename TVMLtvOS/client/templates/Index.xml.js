  ...
  <listTemplate>
    <list>
      ...
      <section>
        ...
        <listItemLockup template="${this.BASEURL}templates/Showcase.xml.js" accessibilityText="Accessible showcase template">
          <title>Showcase</title>
          <relatedContent>
            <lockup>
              <img src="${this.BASEURL}resources/images/templates/showcase.jpg" width="857" height="482" />
              <description class="descriptionLayout">Use the showcase template to display a row of images with descriptions associated with each image; for example, displaying a set of screenshots to promote a movie.</description>
            </lockup>
          </relatedContent>
        </listItemLockup>
